...
\begin{document}
	...
	\begin{equation}
		...
		\end{cases}
	\end{equation}
	i.e. il existe $f: \mathbb{R}^4 \longrightarrow \mathbb{R}^4$ tel que $\dot{X} = f(X)$ où $X = (x,y,v_x,v_y)^T$ est l'état du système. On cherche alors à linéariser (\ref{full motion equation}) de manière à obtenir $A \in \mathcal{M}_{4,4}(\mathbb{R})$ qui vérifie autour de l'équilibre que $\dot{X} = AX$.
