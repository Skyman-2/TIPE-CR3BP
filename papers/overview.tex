...
\begin{document}
	...
	On peut alors remplacer les coordonnées de L1 dans ces équations (on fait alors une composition de développements limités). On sait que L1 a pour coordonnée $((1-\mu)R-(\frac{\mu}{3})^\frac{1}{3}R, 0)$ ce qui nous permet d'écrire $r_1^2(L_1) = (1-(\frac{\mu}{3})^\frac{1}{3}R)^2$ ainsi que $r_2^2(L_1) = (\frac{\mu}{3})^\frac{2}{3}R$. On peut reconnaitre, grâce à $y=0$, que
	\begin{equation}
		 \begin{cases}
