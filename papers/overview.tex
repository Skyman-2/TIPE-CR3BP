...
\begin{document}
	...
	On résout alors les équations aux valeurs propres
	\begin{equation}
		\label{eq aux vp eta}
		\begin{cases}
			A\eta = \lambda \eta
	...
	Pour ce faire, on pose $\eta =: (\eta_1, \eta_2, \eta_3, \eta_4)$. Alors $\eta$ vérifie l'équation \ref{eq aux vp eta}.1 si, et seulement si $\eta$ vérifie le système
	\begin{equation}
		(S) \ \
		\begin{cases}
			\eta_3 = \lambda \eta_1
			...
			\eta_4 = \lambda \eta_2
			\\
			9\omega^2 \eta_1 + 2\omega \eta_4 = \lambda \eta_3
			\\
			-3\omega^2 \eta_2 + -\omega \eta_3 = \lambda \eta_4	
		\end{cases}
	\end{equation}
