...
\begin{document}
	...
	On sait que $\gamma$ vérifie l'équation différentielle du système linéarisé, car $A = Df(\gamma)$ où $f$ est la fonction qui donne le système (\ref{full motion equation}). Alors $\gamma(t) = A \gamma(0)$. Par périodicité de $\gamma$, on a
	\begin{equation}
		\gamma(0) = \gamma(T) = \Phi(T)\gamma(0)
	\end{equation} 
	donc 1 est une valeur propre de la matrice de Monodromie, et $\gamma(0)$ en est un vecteur propre. On peut remarquer que ce résultat est généralement valable pour toute matrice de Monodromie de tout système à coefficients périodiques continues.
	...
	\begin{equation}
		JE(x_0)M = JE(x_0)
	\end{equation}
	ce qui montre bien que $JE(x_0)$ est un vecteur propre.
	
	Montrons que $JE(x_0)$ et $\gamma(0)$ sont indépendants.
