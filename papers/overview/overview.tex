...
\begin{document}
	...
	\begin{equation}
		\begin{cases}
			\frac{1}{\lambda_{Lune/Terre}} = \frac{T_Lune}{2\pi}\frac{1}{\sqrt{1+2\sqrt{7}}} \approxeq \frac{28\times24\times3600}{2\pi}\times\frac{1}{\sqrt{1+2\sqrt{7}}} = 1,54.10^{5}s = 1,8 \ \text{jours}
			\\
