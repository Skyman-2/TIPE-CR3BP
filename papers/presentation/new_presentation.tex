...
\begin{document}	
	...
	\begin{frame}
		...
		\begin{columns}
			...
			\begin{equation*}
				r_1 = r_2 = R
			\end{equation*}
			{\small où $r_1$ et $r_2$ sont défini comme dans la figure \ref{fig:schéma du référentiel de co-rotation avec la ligne M1-M2}.}
		\end{columns}
	\end{frame}
	...
	\subsection{Stabilité des points colinéaires}
	\begin{frame}
	...
	\begin{frame}
		...
		\begin{equation}
			X_{pos} \in \{ t \to
			\begin{bmatrix}
				C_1e^{\lambda t} + C_2e^{-\lambda t} + C_3\sin(\nu t) + C_4\cos(\nu t)
				\\
	...
	\begin{frame}
		...
		\begin{columns}
			...
			\begin{figure}
				...
				\caption{Interpolation exponentielle de la dégénerescence de la position en $L1$. \textit{Coefficient de détermination de $R^2=0.9893$.}}
			\end{figure}
