...
\begin{document}	
	...
	\begin{frame}
		...
		\begin{columns}[T]
			...
			{\footnotesize On intègre le système non-linéaire \ref{équations du mouvement} en prenant comme condition initiale celle précédente.}
	...
	\begin{frame}
		...
		\begin{columns}
			...
			On a que $J\eta(t,x_0) = \Phi(t)$. Et en $t = T$, on obtient bien
			\begin{equation*}
