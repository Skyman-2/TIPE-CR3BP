...
\begin{document}
	...
	Et on obtient bien ainsi les dérivées premières.
	\\
	
	Explicitons le lien entre R et $r_{1}$ et $r_{2}$. On commence par imposer la condition d'équilibre, et remplacer par son expression $\omega^2 = \frac{G(M_1+M_2)}{R^3}$ :
	\begin{equation*}
		\begin{cases}
